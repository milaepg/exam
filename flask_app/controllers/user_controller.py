...
def dashboard():
    ...
    return render_template('dashboard.html', one_user=one_user,data_tree = Plant.get_all())
...
def display_user_acct():
    ...
    return render_template('account.html', one_user=one_user, all_tree=Plant.get_all())
